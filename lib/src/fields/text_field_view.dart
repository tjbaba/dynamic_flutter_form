...
/// Text field widget matching your original design with theme support
class DynamicTextFieldView extends StatefulWidget {
  ...
  @override
  State<DynamicTextFieldView> createState() => _DynamicTextFieldViewState();
}

class _DynamicTextFieldViewState extends State<DynamicTextFieldView> {
  ...
  @override
  void didUpdateWidget(DynamicTextFieldView oldWidget) {
